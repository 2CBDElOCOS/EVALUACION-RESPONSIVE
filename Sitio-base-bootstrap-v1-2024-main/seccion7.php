        ...
        <div class="subcontainer2">
            <div class="row hero2">
                <div class="col-md-12 ico-footer">
                    <a href="seccion6.php"><i class="fa-solid fa-tent-arrow-turn-left"></i></a>
                </div>

                <h1>RESTAURANTES</h1>

                <div class="row restaurantes">
                    <div class="col-md-4 comida">
                        <a href="productos.html"><img src="media/RES1.png" alt="pizza hot"></a>
                    </div>
                    <div class="col-md-4 comida">
                        <img src="media/RES2.png" alt="" >
                    </div>
                    <div class="col-md-4 comida">
                        <img src="media/RES3.png" alt="" >
                    </div>
                </div>
                <div class="row restaurantes">
                    <div class="col-md-4 comida"></div>
                    <div class="col-md-4 comida"></div>
                    <div class="col-md-4 comida"></div>
                </div>
            </div>
