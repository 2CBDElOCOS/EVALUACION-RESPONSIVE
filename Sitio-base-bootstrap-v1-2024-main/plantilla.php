        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse" style="height: 0px;">
            <ul class="nav">
              ...
              <li><a href="controlador.php?seccion=seccion4" target="blank">Ingresa</a></li>
              <li><a href="controlador.php?seccion=seccion5" target="blank">Consulta</a></li>
              <li><a href="controlador.php?seccion=seccion6" target="blank">Tienda</a></li>
              <li><a href="controlador.php?seccion=seccion7" target="blank">Restuarante</a></li>
            </ul>
          </div>
        </div>
      </div>
