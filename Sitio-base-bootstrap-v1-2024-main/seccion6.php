    ...
    <header class="fixed-top bg-dark">
      <div class="row align-items-center">
        ...
        <div class="col-md-9 d-md-flex justify-content-md-end align-items-center">
          <nav class="navlist">
            <a href="plantilla.php" class="active">Inicio</a>
            <a href="#sobre">Sobre nosotros</a>
            <a href="login.html" target="_blank">Nuestra tienda</a>
            <a href="#contactanos">Contactanos </a>
          </nav>
          <div class="nav-icons1">
            <a href="#"><i class="bx bx-search"></i></a>
            <a href="#"><i class="bx bx-cart"></i></a>
            <a href="perfil.html"><i class="bx bx-user-circle"></i></a>
          </div>
        </div>
      </div>
    ...
    <div class="subcontainer">
      <div class="row hero1">
        ...
        <div class="col-md-12 ico-hero">
          <a href="seccion7.php" target="_blank"><i class='bx bx-restaurant'></i></a>
          <a href="bebidas.html" target="_blank"><i class="fa-solid fa-martini-glass-citrus"></i></a>
        </div>
      </div>
    </div>
  </section>
